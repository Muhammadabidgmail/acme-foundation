bootstrap_folder_name = "info-TFC-bootstrap"
folders = {
  admin  = "info-acme-admin"
  dev    = "info-acme-dev",
  stg    = "info-acme-stg",
  prd    = "info-acme-prd",
  shared = "info-acme-shared-services"
}
terraform_service_accounts = {
  "tf-admin" = {
    description = "Service account that creates projects in the admin folder"
    workspaces  = ["01-cloud-administration-global"]
    iam_folder_roles = {
      admin = [
